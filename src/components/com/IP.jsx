      ...
      if( screenWidth < 768 ){
        ...
        return (
            <View>
                ...
                <div><br></br></div>
                <Grid>
                <div className="col-lg-6 col-lg-offset-3 col-xs-12" style={{backgroundColor: "white", border: "thick solid black"}}><h3 style={{color: "red", textAlign:"center"}}>International Press</h3></div>
                <div className="col-lg-12 col-xs-12"><br></br><br></br></div>
                <div className="col-xs-1 col-lg-12"><br></br><br></br></div>

                <div style={{border: "thick solid black"}}>
                <div className="col-lg-12 col-xs-12" style={{border: "thick solid black", backgroundColor: "white"}}>
...
The IP also consists of photographers, a much needed aspect for its functioning, covering the moments in committee as discussion unfold, capturing the vital moments that define it. <br></br>
                ...
                <p style={{color:"black", textAlign: "center"}}><br></br>Keerthishree Raghu</p> <br></br></div>
                </div>
                ...
                <p style={{color:"black", textAlign: "center"}}><br></br>Tulica Bhattacharya</p><br></br></div>
                </div>
                <div className="col-xs-1"><br></br><br></br></div>
                ...
                <p style={{color:"black", textAlign: "center"}}><br></br>Keerthivasan</p><br></br></div>
                </div>
                <div className="col-lg-12 col-xs-1"><br></br><br></br></div>
...
/>
      ...
      <Image src="../images/heartimg.png" style={{position: "relative", width: "50px", height: "50px"}}/>
        ...
        style={{width: '100%', height: '100%', opacity: 0.8, marginTop: "3em"}} >
                <ScrollUpButton />
                <div><br></br></div>
                <Grid>
                <div className="col-lg-6 col-lg-offset-3 col-xs-12" style={{}}><h3 style={{color: "white", textAlign:"center"}}>International Press</h3></div>
                <div className="col-lg-12 col-xs-12"><br></br><br></br></div>
                <div className="col-xs-1 col-lg-12"><br></br><br></br></div>

                <div style={{border: "thick solid black"}}>
                <div className="col-lg-12 col-xs-12" style={{border: "thick solid black", backgroundColor: "white",background: "url('../images/com/IPbgmFlip.jpeg')"}}>
