...
The UNHRC is one of the six councils being simulated at SSN MUN this year.<br></br>
                ...
                <div className="col-lg-3 col-xs-12" style={{border: "thick solid blue", backgroundColor: "black"}}><h4 style={{color: "white", textAlign:"center"}}>Director</h4><Image src="../images/unhrc/1.png" style={{position: "relative", width: "100%", height: "100%"}}/>
                <p style={{color:"white", textAlign: "center"}}><br></br>Ishita M</p> <br></br></div>
                </div>
                <div className="col-xs-1"><br></br><br></br></div>
                <div style={{border: "thick solid blue"}}>
                <div className="col-lg-3 col-xs-12" style={{border: "thick solid blue", backgroundColor: "black"}}><h4 style={{color: "white", textAlign:"center"}}>Chair-person</h4><Image src="../images/unhrc/2.jpg" style={{position: "relative", width: "100%", height: "100%"}}/>
                <p style={{color:"white", textAlign: "center"}}><br></br>Adiya Kumar</p><br></br></div>
                </div>
                <div className="col-xs-1"><br></br><br></br></div>

                <div style={{border: "thick solid blue"}}>
                <div className="col-lg-3 col-xs-12" style={{border: "thick solid blue", backgroundColor: "black"}}><h4 style={{color: "white", textAlign:"center"}}>Vice Chair-person</h4><Image src="../images/unhrc/3.jpg" style={{position: "relative", width: "100%", height: "100%"}}/>
