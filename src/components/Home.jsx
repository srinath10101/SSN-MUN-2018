  ...
  />
    ...
    />
          <ScrollUpButton/>
                    <div><br></br><br></br></div>      
                    <Grid id="whole">
                    <div className="col-lg-12" style={{border: "medium solid black", background: "url('images/hd2flipped.jpg')"}}><h2 style={{color: "black", textAlign: "center"}}><b>Letter from the Secretary General</b></h2><p style={{color: "black"}}>
